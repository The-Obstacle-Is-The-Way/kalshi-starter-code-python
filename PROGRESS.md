...
- [x] **SPEC-033**: Exa Research Agent → `docs/_specs/SPEC-033-exa-research-agent.md` [NEEDS-FIX]
- [ ] **SPEC-033-FIX**: Add crash recovery for deep research tasks (persist research_id, use list/find reconciliation)
