...
Note: `analysis/scanner.py` (439 LoC) was split into `_scanner_models.py` (46), `_verifier.py` (117), `scanner.py` (304) (D14, 2026-01-21).
Note: `analysis/correlation.py` (448 LoC) was split into `_correlation_models.py` (98), `_arbitrage.py` (184), `correlation.py` (274) (D15, 2026-01-21).
...
**Note (2026-01-21):** Phases A–C complete. Phase D in progress — 3 files still exceed 400 lines (see Evidence section for the current list). D1–D15 completed (cli/market.py, cli/data.py, cli/portfolio.py, cli/alerts.py, cli/research/thesis/_commands.py, agent/research_agent.py, agent/providers/llm.py, execution/executor.py, exa/client.py, exa/websets/client.py, portfolio/pnl.py, portfolio/syncer.py, analysis/liquidity.py, analysis/scanner.py, analysis/correlation.py → split modules).
