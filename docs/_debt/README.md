...
| **[DEBT-015](DEBT-015-missing-api-endpoints.md)** | Missing API Endpoints - Phase 5 Decision | **P3** | 🟡 Decision Pending |
...
| `DEBT-015-missing-api-endpoints.md` | **Active debt P3** - Phase 5 decision on remaining 27 endpoints |
