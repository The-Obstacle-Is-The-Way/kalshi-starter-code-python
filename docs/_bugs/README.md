...
### Recently Archived (2026-01-20)

| ID | Title | Status |
|---|---|---|
| **[BUG-088](../_archive/bugs/BUG-088-cli-tests-order-dependent-client-factory-patching.md)** | CLI Tests Order-Dependent After `client_factory` Migration | ✅ Fixed |
