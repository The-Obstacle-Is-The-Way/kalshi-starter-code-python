...
**Root Cause:** Hardcoded character limits don't adapt to terminal width and truncate valid tickers (some exceed 57 chars).
...
def _ticker_width() -> int:
    ...
    return max(20, min(60, available))  # Clamp between 20-60
```
...
- Long: `KXMVESPORTSMULTIGAMEEXTENDED-S202568BBB7B950E-9EA0AA473FC` (57 chars)

Maximum observed: 60+ chars. Display width logic must be robust to extreme lengths.
